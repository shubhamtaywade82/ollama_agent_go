...
// RunShell executes a shell command with the sandbox root as the working directory.
...
func (t *RunShell) Description() string { return "Run a shell command in the project root and return its combined stdout/stderr and exit status. Use for builds, tests, and git. Commands run under a timeout." }
